...
(19, 'Gladys Night & The Pips', 4, 'Gladys Maria Knight (born May 28, 1944), known as the \"Empress of Soul\",[1][2] is an American singer, songwriter, actress, businesswoman, and author. A seven-time Grammy Award-winner,[3] Knight is known for the hits she recorded during the 1960s, 1970s, and 1980s with her group Gladys Knight & the Pips, which also included her brother Merald \"Bubba\" Knight and cousins Edward Patten and William Guest. ', 19, 1, 'gladysknightpips-img.jpg', 'gladysknightpips-tn.jpg'),
(20, 'Raphael Saadiq', 3, 'Raphael Saadiq (/səˈdiːk/; born Charles Ray Wiggins; May 14, 1966) is an American singer, songwriter, multi-instrumentalist, and record producer. He rose to fame as a member of the multiplatinum group Tony! Toni! Toné!', 5, 1, 'raphaelsaadiq-img.jpg', 'raphaelsaadiq-tn.jpg');
...
(8, 'Gladys Night & The Pips Reunion Tour 2020', 'Gladys Night & The Pips Reunion Tour 2020', '2020-08-01 21:20:47', 19, '199.00');
...
--
ALTER TABLE `bands`
  MODIFY `bandID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `genre`
  MODIFY `genreID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
COMMIT;
